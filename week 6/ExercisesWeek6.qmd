...
clean_tip_labels <- sapply(stretched_tree$tip.label, function(label) {
...
# Create a legend positioned lower on the right side (using x,y coordinates)
# First get the plot dimensions
plot_dims <- par("usr")
legend(x = plot_dims[2] * 0.8,  # Horizontal
       y = plot_dims[4] * 0.95,   # Vertical
       legend = c("Reference", 
                  "Early (323 days)", 
